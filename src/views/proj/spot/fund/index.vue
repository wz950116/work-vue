    ...
    return {
      ...
      form: {
        ...
        formData: [
          {
            width: 120,
            label: 'spotProj.fund.form.organCode',
            prop: 'organCode',
            element: 'base-select',
            attrs: {
              data: 'TREE_ORGAN',
          ...
          {
            width: 100,
            label: 'spotProj.fund.form.deptCode',
            prop: 'deptCode',
            element: 'base-select',
            attrs: {
              data: 'TREE_DEPT',
          ...
          {
            label: 'spotProj.fund.form.purchaseSaleType',
          ...
          {
            label: 'spotProj.fund.form.documentStat',
            prop: 'auditStatus',
            element: 'base-select',
            width: 120,
            ...
            getParam() {
              return {
                ...
                todotext: {
                  ...
                  value: '资金: ' + this.$refs.qmTable.currentRow.documentNo // 变量值
                }
              }
            }
          },
          ...
          cols: [
            {
              width: '80',
              prop: 'auditStatus',
              label: 'spotProj.fund.list.documentStat',
              align: 'center',
              format: {
            ...
            {
              prop: 'organName',
              label: 'spotProj.fund.list.organName',
              width: '100'
            },
            {
              prop: 'deptName',
              label: 'spotProj.fund.list.deptName',
              width: '100'
            },
            {
              prop: 'documentNo',
              label: 'spotProj.fund.list.documentNo',
              width: '120'
            },
            {
              prop: 'documentDate',
              label: 'spotProj.fund.list.documentDate',
              width: '100',
              align: 'center',
              format: {
                dict: 'yyyy-MM-dd',
            ...
            },
            {
              ...
              align: 'center',
              width: '80',
              label: 'spotProj.fund.list.purchaseSaleType',
              format: {
            ...
            },
            {
              prop: 'customerName',
              width: '100',
              label: 'spotProj.fund.list.supplierName'
            },
            {
              prop: 'originalCurrencyName',
              width: '100',
              label: 'spotProj.fund.list.originalCurrencyName'
            },
            {
              prop: 'originalCurrencyAmt',
              align: 'right',
              width: '100',
              label: 'spotProj.fund.list.originalCurrencyAmt',
              format: {
                dict: 'thousandth',
                func: 'moneyFilter'
              }
            ...
            },
            {
              ...
              align: 'right',
              width: '100',
              label: 'spotProj.fund.list.matchAmt',
              format: {
                dict: 'thousandth',
                func: 'moneyFilter'
              }
            },
            {
              ...
              align: 'right',
              width: '100',
              label: 'spotProj.fund.list.unmatchAmt',
              format: {
                dict: 'thousandth',
                func: 'moneyFilter'
              }
            },
            {
              ...
              width: '80',
              align: 'center',
              label: 'spotProj.fund.list.preliminaryFlag',
              format: {
            ...
            },
            {
              prop: 'remark',
              width: '160',
              label: 'spotProj.fund.list.remark'
            },
            {
              prop: 'makeUserName',
              width: '80',
              label: 'spotProj.fund.list.makeUserName'
            },
            {
              prop: 'makeDt',
              label: 'spotProj.fund.list.makeDt',
              align: 'center',
              width: '160'
            }
          ]
  ...
  methods: {
    ...
    cancelAudit() {
      ...
      if (this.$refs.qmTable.currentRow.auditStatus !== '3') {
        this.$notify(
          notifyInfo({
            msg: this.$t('spotProj.fund.msg.costNotAudit')
          })
        )
        return
      }
