<template>
  <div v-el-drag-dialog class='dialog-wrapper'>
    <div class='dialog-container' type='mini' :style="{width: this.sidebar.opened ? '250px' : '400px', height: '140px'}">
      <TitleContain :titleName='$t("strategy.posMatch.dialog.matchType")' @TitleFun="closeTitleDialog" />
