<template>
  <div>
    ...
    <planRelationDialog v-if="dialogVisible" :contractCode='contractCode' :direction='direction' :showZero="showZero" @close="dialogClose" @confirm="confirm"></planRelationDialog>
  </div>
</template>

<script>
import planRelationDialog from '@/views/frame/rm/strategy/strgPosMatch/components/planRelationDialog'
