        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-form-item :label="$t('strategy.strategyManagement.form.riskProfitRatio')" prop='riskProfitRatio'>
              <input-formatter v-model="formData.riskProfitRatio" :min="0" :max='999999999999' :precision="2" type='thousands'></input-formatter>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item :label="$t('strategy.strategyManagement.form.expectReturnRatio')" prop='expectReturnRatio'>
              <input-formatter v-model="formData.expectReturnRatio" :min="0" :max='999999999999' :precision="2" type='thousands'></input-formatter>
            </el-form-item>
          </el-col>
...
import hedgingPortfolio from '@/views/frame/rm/strategy/strategyManagement/hedging/hedgingPortfolio'
...
export default {
  ...
  data() {
    return {
      ...
      validateList: ['itemClass', 'productCode', 'price', 'quantity', 'unitCode', 'currencyCode'],
      formData: {
  ...
  methods: {
    ...
    checkDetail() {
      ...
      list.forEach(element => {
        ...
        // if (
        //   element.itemClass === '1' &&
        //   !element.valuationCode &&
        //   !errMsg.includes('类型为现货时,估值基准不能为空')
        // ) {
        //   errMsg = errMsg + '类型为现货时,估值基准不能为空;'
        // }
    ...
    auditHistory() {
      ...
      // this.dialogParam.uk = this.$route.meta.
