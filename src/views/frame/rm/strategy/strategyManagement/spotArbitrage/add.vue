...
import hedgingPortfolio from '@/views/frame/rm/strategy/strategyManagement/spotArbitrage/hedgingPortfolio'
  ...
  methods: {
    ...
    checkDetail() {
      ...
      list.forEach(element => {
        ...
        // if (!element.valuationCode && !errMsg.includes('估值基准不能为空')) {
        //   errMsg = errMsg + '估值基准不能为空;'
        // }
