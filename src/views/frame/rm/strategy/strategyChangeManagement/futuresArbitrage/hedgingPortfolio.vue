        ...
        <el-table stripe border height="150" ref="buyTable" class="table-content tb-edit" :data="buyData" style="border:1px solid;" @selection-change="buyHandleSelectionChange">
          ...
          <el-table-column :label="$t('strategy.strategyManagement.tab.productCode')" width="120">
            ...
            <template slot-scope="scope">
              <base-select size="mini" v-model="scope.row.productCode" :attrs="{data:'FUTURES_VARIETIES',clearable:true,params:{usingFlag:'1'},disabled:matchFlag ,filterable: true}" @changeAll="v=>triggerEvent1({val:v,row:scope.row})"></base-select>
            </template>
          </el-table-column>
          <el-table-column :label="$t('strategy.strategyManagement.tab.contractCode')" width="120">
            <template slot-scope="scope">
              <base-select size="mini" v-model="scope.row.contractCode" :attrs="{data: 'FUTURES_CONTRACT',clearable:true,params:{futuresVarietiesCode:scope.row.productCode},disabled:matchFlag ,filterable: true}">
              </base-select>
            </template>
          </el-table-column>
          ...
          <el-table-column :label="$t('strategy.strategyManagement.tab.marketCode')" width="140">
            <template slot-scope="scope">
              <base-select size="mini" v-model="scope.row.marketCode" :attrs="{data: 'EXCHANGE',clearable:true,disabled:matchFlag}"></base-select>
            </template>
          </el-table-column>
        </el-table>
      </el-col>
      <el-col :span="12">
        ...
        <el-table stripe border height="150" highlight-current-row ref="sellTable" class="table-content tb-edit" :data="sellData" style="border:1px solid;" @selection-change="sellHandleSelectionChange">
          ...
          <el-table-column :label="$t('strategy.strategyManagement.tab.productCode')" width="120">
            ...
            <template slot-scope="scope">
              <base-select size="mini" v-model="scope.row.productCode" :attrs="{data:'FUTURES_VARIETIES',clearable:true,params:{usingFlag:'1'},disabled:matchFlag ,filterable: true}" @changeAll="v=>triggerEvent2({val:v,row:scope.row})"></base-select>
            </template>
          </el-table-column>
          <el-table-column :label="$t('strategy.strategyManagement.tab.contractCode')" width="120">
            <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    triggerEvent1(value) {
      this.buyData[value.row.rowNum].contractCode = ''
    },
    triggerEvent2(value) {
      this.sellData[value.row.rowNum].contractCode = ''
    },
    // 获取初始化数据
    getEditData() {
