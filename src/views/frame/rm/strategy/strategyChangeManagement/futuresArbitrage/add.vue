    ...
    <main>
      <el-tabs v-model="activeName" type="border-card">
        <el-tab-pane :label="$t('strategy.strategyManagement.form.arbitragePortfolio')" name="hedgingPortfolio">
          <hedgingPortfolio :type='type' ref="productTab" :changeNo='this.$route.params.uk' :flag='flagF' :strgEquation1='formData.strgEquation' :maxShare='formData.maxShare' :matchFlag='matchFlag'></hedgingPortfolio>
        </el-tab-pane>
      </el-tabs>
...
import hedgingPortfolio from '@/views/frame/rm/strategy/strategyChangeManagement/futuresArbitrage/hedgingPortfolio'
