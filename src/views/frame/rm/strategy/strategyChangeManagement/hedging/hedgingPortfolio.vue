  ...
  <div>
    ...
    <el-row :gutter="20" style="border-top:1px solid #aaaaaa;">
      <el-col :span="12" style="border-right:1px solid #aaaaaa;">
        ...
        <el-table stripe border height="150" ref="buyTable" class="table-content tb-edit" :data="buyData" style="border:1px solid;" @selection-change="buyHandleSelectionChange" @cell-click="handleClick">
          ...
          <el-table-column :label="$t('strategy.strategyManagement.tab.productCode')" width="120">
            ...
            <template slot-scope="scope">
              ...
              <!-- <base-select v-if='scope.row.itemClass==="1"' size="mini" v-model="scope.row.productCode" :attrs="{data: 'DD_PRODUCT',clearable:true,params:{usingFlag:'1'},disabled:matchFlag ,filterable: true}"></base-select> -->
      ...
      <el-col :span="12">
        ...
        <el-table stripe border height="150" highlight-current-row ref="sellTable" class="table-content tb-edit" :data="sellData" style="border:1px solid;" @selection-change="sellHandleSelectionChange" @cell-click="handleClick">
          <el-table-column type="index" fixed="left" :label="$t('table.id')" width="50" align="center">
          </el-table-column>
          <el-table-column type="selection" width="45" align="center"></el-table-column>
