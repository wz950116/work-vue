        ...
        <el-table stripe border height="150" ref="buyTable" class='table-content tb-edit' :data="tableData" style="border:1px solid;" @selection-change="handleSelectionChange">
          ...
          <el-table-column :label="$t('strategy.strategyManagement.tab.productCode')" width="120">
            ...
            <template slot-scope="scope">
              <base-select size="mini" v-model="scope.row.productCode" :attrs="{data: 'FUTURES_VARIETIES',clearable:true,params:{usingFlag:'1'},disabled:matchFlag ,filterable: true}" @changeAll='v=>changeProductCode({val:v,row:scope.row})'></base-select>
            </template>
          </el-table-column>
