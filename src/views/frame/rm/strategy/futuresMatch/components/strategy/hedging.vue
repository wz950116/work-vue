<template>
  <div>
    <div>
      ...
      <el-table stripe border height="150" highlight-current-row ref="buyTable" class='table-content tb-edit' :data="tableData" style="border:1px solid;" @current-change="handleCurrentChange">
        ...
        <el-table-column :label="$t('strategy.strategyManagement.tab.itemClass')" width="120">
        ...
        <el-table-column :label="$t('strategy.strategyManagement.tab.remark')" width="160" prop="remark">
        </el-table-column>
      </el-table>
    </div>
