  ...
  <div>
    <div>
      ...
      <el-table stripe border height="150" highlight-current-row ref="strategyInfo" class='table-content tb-edit' :data="tableData" style="border:1px solid;" @current-change="handleCurrentChange">
        ...
        <el-table-column width="150" :label="$t('strategy.plan.list.productCode')" prop="productName"></el-table-column>
        <el-table-column width="150" :label="$t('strategy.plan.list.contractCode')" prop="contractName"></el-table-column>
