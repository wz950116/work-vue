    ...
    <main>
      <el-tabs v-model="activeName" type="border-card">
        <el-tab-pane :label="$t('strategy.plan.tab.hedgingPortfolio')" name="hedgingPortfolio">
          <hedgingPortfolio ref="hedgeDialog" :disabled="matchFlag" :strategyCode="formData.strategyCode" :strgEquation="formData.strgEquation" :maxShare="formData.maxShare" :enterMode="formData.enterMode" :strategyNature="formData.strategyNature"></hedgingPortfolio>
        </el-tab-pane>
      </el-tabs>
...
<script>
import hedgingPortfolio from '@/views/frame/rm/strategy/plan/futuresHedge/hedgingPortfolio'
