<template>
  <div>
    <futuresSpotHedgeEditForm v-if="['1','6'].includes(formData.strategyNature)"></futuresSpotHedgeEditForm>
    <futuresHedgeEditForm v-if="['2'].includes(formData.strategyNature)"></futuresHedgeEditForm>
    <spotHedgeEditForm v-if="['3'].includes(formData.strategyNature)"></spotHedgeEditForm>
    <futuresSingleEditForm v-if="['4'].includes(formData.strategyNature)"></futuresSingleEditForm>
    <spotSingleEditForm v-if="['5'].includes(formData.strategyNature)"></spotSingleEditForm>
  </div>
</template>
