        ...
        <el-table stripe border height="150" highlight-current-row ref="sellMultipleTable" class="table-content tb-edit" :data="sellList" style="border:1px solid;" @current-change="sellListChange">
          ...
          <el-table-column :width="250" :label="$t('strategy.plan.list.quantityLimit')">
            ...
            <template slot-scope="scope">
              <el-row :gutter="0" style="width:100%;">
                <el-col :span="12">
                  <input-formatter :min="0" :max="scope.row.maxQuantity || 999999999999.99" type="thousands" :precision="6" v-model="scope.row.minQuantity" size="mini"></input-formatter>
                </el-col>
                <el-col :span="12">
                  <input-formatter :min="scope.row.minQuantity || 0" :max="999999999999.99" type="thousands" :precision="6" v-model="scope.row.maxQuantity" size="mini"></input-formatter>
                </el-col>
              </el-row>
            </template>
          </el-table-column>
