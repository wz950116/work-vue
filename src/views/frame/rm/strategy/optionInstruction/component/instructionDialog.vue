        ...
        <el-tabs v-model="activeName" type="border-card">
          <el-tab-pane :label="$t( 'biz.lbl.mainInfo')" name="mainInfo">
            <el-table stripe border class='table-content' ref="singleTable" highlight-current-row v-loading="loading" element-loading-spinner="el-icon-loading" :height='250' :element-loading-text="$t( 'route.load')" :data="tableData" @current-change="handleSelectionChange" @row-dblclick="handleDbclick">
              ...
              <el-table-column width="100" :label="$t( 'strategy.optionInstruction.list.deptName')" prop="deptName"></el-table-column>
              <el-table-column width="150" :label="$t( 'strategy.optionInstruction.list.instructionName')" prop="instructionName"></el-table-column>
              <el-table-column width="150" :label="$t( 'strategy.optionInstruction.list.instructionCode')" prop="instructionCode"></el-table-column>
              <el-table-column width="150" :label="$t( 'strategy.optionInstruction.list.planName')" prop="planName"></el-table-column>
              <el-table-column width="150" :label="$t( 'strategy.optionInstruction.list.planCode')" prop="planCode"></el-table-column>
