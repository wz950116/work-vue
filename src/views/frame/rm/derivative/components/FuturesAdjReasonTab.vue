...
<template>
  <div>
    <el-input v-model="inputData" type="textarea" :rows="20" :placeholder="$t('biz.placeholder.input')" :disabled="disabled" resize='none' maxlength='500'></el-input>
  </div>
