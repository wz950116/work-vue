...
<template>
  <el-tabs v-model="activeName" type="border-card">
        ...
        <el-row :gutter="0">
          ...
          <el-col :span="6">
            <el-form-item :label="$t('derivative.futuresAccountAdjust.derivativeAccount')" prop='derivativeAccount'>
              <el-input v-model="baseInfo.derivativeAccount" :disabled="true" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
    ...
    <el-tab-pane :label="$t('derivative.futuresAccountAdjust.listDetailBefore')" name="adjustBeforeTab" v-if="showTabs.includes('adjustBeforeTab')">
      <futures-account-tab :detailDatas='listDetailBefore' :adjustType='type' :useType='useType'></futures-account-tab>
    </el-tab-pane>
    <el-tab-pane :label="$t('derivative.futuresAccountAdjust.listDetailAfter')" name="adjustAfterTab" v-if="showTabs.includes('adjustAfterTab')">
      <futures-account-tab :detailDatas='listDetailAfter' :adjustType='type' :useType='useType'></futures-account-tab>
    </el-tab-pane>
    <el-tab-pane :label="$t('derivative.futuresAccountAdjust.adjustReason')" name="adjustReasonTab" v-if="showTabs.includes('adjustReasonTab')">
...
<script>
import * as futureAdjust from '@/api/frame/rm/derivative/futuresAccountAdjust'
