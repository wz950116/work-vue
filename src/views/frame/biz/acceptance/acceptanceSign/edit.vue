  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/acceptance/sign/get',
          save: '/api/acceptance/sign/save',
          update: '/api/acceptance/sign/update'
        },
        apiData: {
          view(param) {
        ...
        formData: {
          part1: {
            titleName: 'acceptance.acceptanceSign.group.editPart1',
            content: [
              // 单据号
              {
              ...
              // 票面金额
              {
                label: 'acceptance.acceptanceSign.form.acceptanceAmount',
              ...
              // 币种
              {
                label: 'acceptance.acceptanceSign.form.currency',
                prop: 'currency',
                element: 'base-select',
              ...
              // 签发保证金
              {
                label: 'acceptance.acceptanceSign.form.signSecurityDeposit',
              ...
              // 签发手续费
              {
                label: 'acceptance.acceptanceSign.form.signServiceFee',
                prop: 'signServiceFee',
                element: 'input-formatter',
                validate: [
                  {
              ...
              // 付款帐号
              {
                label: 'acceptance.acceptanceSign.form.bankAccountCode',
              ...
              // 付款银行
              {
                label: 'acceptance.acceptanceSign.form.bankCode',
                prop: 'bankCode',
                element: 'base-select',
                validate: [
                  {
