  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/acceptance/receive/get',
          save: '/api/acceptance/receive/save',
          update: '/api/acceptance/receive/update'
        },
        apiData: {
          view(param) {
        ...
        formData: {
          part1: {
            titleName: 'acceptance.acceptanceReceive.group.editPart1',
            content: [
              // 单据号
              {
