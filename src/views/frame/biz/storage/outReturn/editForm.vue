...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/warehouse/whOutReturnBill/get',
          save: '/api/warehouse/whOutReturnBill/save',
          update: '/api/warehouse/whOutReturnBill/update'
        },
        apiData: {
          view(param) {
        ...
        topButtons: [
          ...
          // edit 打印
          {
            ...
            getParam(data) {
              return {
                outReturnNo: data.uk || data.outReturnNo
              }
            },
            event: 'print',
        ...
        formData: {
          part1: {
            titleName: 'storage.outReturn.group.editFormPart1',
            content: [
              // 销售退货单号
              {
        ...
        tables: [
          {
            ...
            name: 'whOutReturnProductDtoList',
            label: 'storage.outReturn.tab.outReturnProduct',
            component: () => import('./outReturnProductTab.vue'),
            required: true
          }
          // {
          //   isShow: ['add', 'update', 'assist', 'audit', 'view'],
          //   name: 'whOutReturnCostList',
          //   label: 'storage.outReturn.tab.cost',
  ...
  methods: {
    ...
    customerCodeChange(val) {
      this.clearOutReturnProductInfo()
    },
    // 业务机构change事件
    ...
    // 清空销售退货商品信息
    clearOutReturnProductInfo() {
      this.$refs.qmEdit.$refs.qmRouteEdit.$refs.whOutReturnProductDtoList[0].$refs.tab.tableData = []
    }
  }
}
</script>
