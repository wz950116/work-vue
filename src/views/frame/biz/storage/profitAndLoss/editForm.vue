...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/warehouse/whPnl/get',
          save: '/api/warehouse/whPnl/save',
          update: '/api/warehouse/whPnl/update'
        },
        apiData: {
          view(param) {
        ...
        formData: {
          part1: {
            titleName: 'storage.profitAndLoss.group.editFormPart1',
            content: [
              // 盘盈亏单号
              {
        ...
        tabs: [
          {
            ...
            name: 'whPnlProductDtoList',
            label: 'storage.profitAndLoss.tab.pnlProduct',
            component: () => import('./pnlProductTab.vue'),
            required: true
          }
        ]
      }
  ...
  methods: {
    ...
    // 清空盘盈亏商品信息
    clearPnlProductInfo() {
      this.$refs.qmEdit.$refs.qmRouteEdit.$refs.whPnlProductDtoList[0].$refs.tab.tableData = []
    }
  }
}
</script>
