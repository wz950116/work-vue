  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/warehouse/whFrozenBill/get',
          save: '/api/warehouse/whFrozenBill/save',
          update: '/api/warehouse/whFrozenBill/update'
        },
        apiData: {
          view(param) {
        ...
        topButtons: [
          ...
          },
          {
            ...
            getParam() {
              return {
                ...
                uk: this.$route.params.uk || this.$route.params.frozenBillNo
              }
            },
            event: 'auditHistory',
          ...
          },
          {
            ...
            getParam(data) {
              return {
                billNo: data.uk || data.frozenBillNo,
          ...
          // edit 打印
          {
            ...
            getParam(data) {
              return {
                frozenBillNo: data.uk || data.frozenBillNo
              }
            },
            event: 'print',
        ...
        formData: {
          part1: {
            titleName: 'storage.frozenBill.group.editFormPart1',
            content: [
              {
              ...
              {
                label: 'storage.frozenBill.form.remark',
                prop: 'remark',
                element: 'el-input',
                attrs: {
                  clearable: true,
        ...
        tabs: [
          {
            ...
            name: 'frozenProductList',
            label: 'storage.frozenBill.tab.product',
