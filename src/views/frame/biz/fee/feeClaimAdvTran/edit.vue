...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/fee/feeClaimAdvTran/get',
          save: '/api/fee/feeClaimAdvTran/save',
          update: '/api/fee/feeClaimAdvTran/update'
        },
        apiData: {
          view(param) {
        ...
        topButtons: [
          ...
          },
          {
            ...
            getParam(data) {
              return {
                transferNo: data.uk || data.transferNo
              }
            },
            event: 'print',
        ...
        formData: {
          part1: {
            titleName: 'fee.feeClaimAdvTran.group.editPart1',
            content: [
              // 单据号
              {
                label: 'fee.feeClaimAdvTran.form.transferNo',
                prop: 'transferNo',
              ...
              {
                type: 'date',
                label: 'fee.feeClaimAdvTran.form.transferDate',
                prop: 'transferDate',
                validate: [
                  {
                    required: true,
              ...
              // 客户
              {
                label: 'fee.feeClaimAdvTran.form.customerNo',
                prop: 'customerNo',
                element: 'base-select',
                validate: [
                  {
              ...
              // 费用收款认领单号
              {
                label: 'fee.feeClaimAdvTran.form.claimNo',
                prop: 'claimNo',
                element: 'input-validate',
                validate: [
                  {
              ...
              // 转换金额
              {
                label: 'fee.feeClaimAdvTran.form.transferAmount',
                prop: 'transferAmount',
              ...
              // 币种
              {
                label: 'fee.feeClaimAdvTran.form.currency',
                prop: 'currency',
                element: 'base-select',
        ...
        tabs: [
          {
            ...
            name: 'feeClaimAdvTranDeDtoList',
            label: 'fee.feeClaimAdvTran.tab.transferDetailInfoTab',
  ...
  methods: {
    ...
    clearTransferDetailInfo() {
      this.$refs.qmEdit.$refs.qmRouteEdit.$refs.feeClaimAdvTranDeDtoList[0].$refs.tab.tableData = []
    }
  }
}
</script>
