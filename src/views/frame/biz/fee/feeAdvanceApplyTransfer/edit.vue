...
export default {
  name: 'feeAdvanceApplyTransferEdit',
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/fee/applyAdvTran/get',
          save: '/api/fee/applyAdvTran/save',
          update: '/api/fee/applyAdvTran/update'
        },
        apiData: {
          view(param) {
        ...
        formData: {
          part1: {
            titleName: 'fee.feeAdvanceApplyTransfer.group.editPart1',
            content: [
              // 单据号
              {
              ...
              // 转换金额
              {
                label: 'fee.feeAdvanceApplyTransfer.form.transferAmount',
                prop: 'transferAmount',
              ...
              // 币种
              {
                label: 'fee.feeAdvanceApplyTransfer.form.currency',
                prop: 'currency',
                element: 'base-select',
        ...
        tabs: [
          {
            ...
            name: 'feeApplyAdvTranDeDtoList',
            label: 'fee.feeAdvanceApplyTransfer.tab.transferDetailInfoTab',
  ...
  methods: {
    ...
    clearTransferDetailInfo() {
      this.$refs.qmEdit.$refs.qmRouteEdit.$refs.feeApplyAdvTranDeDtoList[0].$refs.tab.tableData = []
    }
  }
}
</script>
