  ...
  data() {
    return {
      tab: {
        ...
        api: {
          search: '/api/fee/feeClaimDetail/list'
        },
        apiData: {
          search(param) {
        ...
        table: {
          ...
          cols: [
            // 费用结算单据号
            {
              label: 'fee.feeClaim.detail.settleNo',
              prop: 'settleNo',
              width: 200,
              align: 'left',
              required: true
            ...
            // 费用结算明细单据号
            {
              label: 'fee.feeClaim.detail.settleDetailNo',
              prop: 'settleDetailNo',
              width: 200,
              align: 'left',
              required: true
            ...
            // 费用名称
            {
              label: 'fee.feeClaim.detail.feeNameCode',
              prop: 'feeName',
              width: 200,
              align: 'left',
              required: true
            ...
            // 费用方向
            {
              label: 'fee.feeClaim.detail.feeDirection',
              prop: 'feeDirection',
              width: 100,
              align: 'center',
              element: 'base-select',
            ...
            // 认领金额
            {
              label: 'fee.feeClaim.detail.claimAmount',
              prop: 'claimAmount',
            ...
            // 币种
            {
              label: 'fee.feeClaim.detail.currency',
              prop: 'currency',
              width: 100,
              align: 'center',
              element: 'base-select',
  ...
  methods: {
    ...
    handleCloseDialog(params) {
      ...
      params.forEach((row, index) => {
        ...
        this.$refs.tab.tableData[_index]['claimAmount'] = row.includeTaxAmount
