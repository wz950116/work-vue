  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/fee/feeInvoice/get',
          save: '/api/fee/feeInvoice/save',
          update: '/api/fee/feeInvoice/update'
        },
        apiData: {
          view(param) {
        ...
        topButtons: [
          ...
          },
          {
            ...
            getParam(data) {
              return {
                feeInvoiceNo: data.uk || data.feeInvoiceNo
              }
            },
            event: 'print',
        ...
        formData: {
          part1: {
            ...
            content: [
              ...
              // 不含税金额
              {
                label: 'fee.feeInvoice.form.excludeTaxAmount',
              ...
              // 税额
              {
                label: 'fee.feeInvoice.form.taxAmount',
                prop: 'taxAmount',
                element: 'input-formatter',
                validate: [
                  {
              ...
              // 含税金额
              {
                label: 'fee.feeInvoice.form.includeTaxAmount',
              ...
              // 币种
              {
                label: 'fee.feeInvoice.form.currency',
                prop: 'currency',
                element: 'base-select',
        ...
        tabs: [
          {
            ...
            name: 'feeInvoiceDetailDtoList',
            label: 'fee.feeInvoice.tab.feeInvoiceDetailInfoTab',
