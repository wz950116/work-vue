...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/fee/invoiceApply/get',
          save: '/api/fee/invoiceApply/save',
          update: '/api/fee/invoiceApply/update'
        },
        apiData: {
          view(param) {
        ...
        formData: {
          part1: {
            titleName: 'fee.feeInvoiceApply.group.editPart1',
            content: [
              // 单据号
              {
              ...
              // 不含税金额
              {
                label: 'fee.feeInvoiceApply.form.excludeTaxAmount',
              ...
              // 税额
              {
                label: 'fee.feeInvoiceApply.form.taxAmount',
                prop: 'taxAmount',
                element: 'input-formatter',
                validate: [
                  {
              ...
              // 含税金额
              {
                label: 'fee.feeInvoiceApply.form.includeTaxAmount',
        ...
        tabs: [
          {
            ...
            name: 'feeInvoiceApplyDetailDtoList',
            label: 'fee.feeInvoiceApply.tab.applyDetailInfoTab',
  ...
  methods: {
    ...
    clearApplyDetailInfo() {
      this.$refs.qmEdit.$refs.qmRouteEdit.$refs.feeInvoiceApplyDetailDtoList[0].$refs.tab.tableData = []
    }
  }
}
</script>
