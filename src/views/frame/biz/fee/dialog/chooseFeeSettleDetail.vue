...
export default {
  data() {
    return {
      dialog: {
        titleName: this.$t('fee.feeSettle.popup.feeSettleDetail'),
        moreShowFlg: false,
        ...
        formData: [
          ...
          // 费用方向
          {
            ...
            prop: 'feeDirection',
            element: 'base-select',
            list: this.$t('datadict.feeDireciton'),
            validate: [
              {
                required: true,
                trigger: 'change'
          ...
          {
            label: 'fee.feeSettle.feeSettleDetail.settleDetailNo',
            prop: 'settleDetailNo',
        ...
        mainData: {
          api: {
            search: '/api/fee/feeSettleDetail/query'
          },
          apiData: {
            search(listQuery) {
          ...
          table: {
            ...
            cols: [
              // 费用结算单据号
              {
                label: 'fee.feeSettle.feeSettleDetail.settleNo',
                prop: 'settleNo',
                width: 150,
                align: 'left'
              },
              ...
              // 分摊金额
              {
                label: 'fee.feeSettle.feeSettleDetail.allotAmount',
                prop: 'allotAmount',
                align: 'right',
                width: 150,
                format: {
