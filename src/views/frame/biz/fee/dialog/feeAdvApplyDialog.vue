        ...
        mainData: {
          ...
          table: {
            ...
            cols: [
              // 单据号
              {
                label: 'fee.feeApplyInfo.list.applyNo',
                prop: 'applyNo',
                width: 200,
                align: 'left',
                sortable: 'custom'
              ...
              // 申请日期
              {
                label: 'fee.feeApplyInfo.list.applyDate',
                prop: 'applyDate',
                format: {
                  dict: 'yyyy-MM-dd',
                  func: 'dateFormat'
              ...
              // 客户
              {
                label: 'fee.feeApplyInfo.list.customerNo',
                prop: 'customerName',
                width: 200,
                align: 'left',
                sortable: 'custom'
              ...
              // 申请类型
              {
                label: 'fee.feeApplyInfo.list.applyType',
                prop: 'applyType',
                format: {
              ...
              // 业务类别
              {
                label: 'fee.feeApplyInfo.list.businessType',
                prop: 'businessType',
                format: {
                  dict: this.$t('datadict.feeApplyBusinessType')
                },
                width: 100,
                align: 'center',
                sortable: 'custom'
              ...
              // 申请金额
              {
                label: 'fee.feeApplyInfo.list.applyAmount',
                prop: 'applyAmount',
                format: {
                  func: 'money'
                },
              ...
              // 币种
              {
                label: 'fee.feeApplyInfo.list.currency',
                prop: 'currency',
                format: {
              ...
              // 最迟付款日期
              {
                label: 'fee.feeApplyInfo.list.latestPaymentDate',
              ...
              // 确认状态
              {
                label: 'fee.feeApplyInfo.list.confirmStatus',
                prop: 'confirmStatus',
                format: {
              ...
              // 确认金额
              {
                label: 'fee.feeApplyInfo.list.confirmAmount',
                prop: 'confirmAmount',
                format: {
                  func: 'money'
                },
              ...
              // 使用状态
              {
                label: 'fee.feeApplyInfo.list.useStatus',
                prop: 'useStatus',
                format: {
              ...
              // 使用金额
              {
                label: 'fee.feeApplyInfo.list.usedAmount',
                prop: 'usedAmount',
                format: {
                  func: 'money'
                },
