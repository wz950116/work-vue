...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/invoice/domNotToCheck/list'
        },
        apiData: {
          search(param) {
            return param
        ...
        table: {
          ...
          cols: [
            ...
            {
              label: 'spot.contractLot.form.dueTicketAmount',
              prop: 'originalAmount',
              align: 'right',
              width: '120',
              format: {
            ...
            {
              label: 'spot.contractLot.form.receivedTicketAmount',
              prop: 'excMemAmount',
              align: 'right',
              width: '120',
              format: {
            ...
            {
              label: 'spot.contractLot.form.unpaidTicketAmount',
              prop: 'rmnMemAmount',
              align: 'right',
              width: '120',
              format: {
            ...
            {
              label: 'spot.contractLot.form.dueTicketQty',
              prop: 'measurementQuantity',
              align: 'right',
              width: '120',
              format: {
            ...
            {
              label: 'spot.contractLot.form.receivedTicketQty',
              prop: 'excMemQty',
              align: 'right',
              width: '120',
              format: {
            ...
            {
              label: 'spot.contractLot.form.unpaidTicketQty',
              prop: 'rmnMemQty',
              align: 'right',
              width: '120',
              format: {
