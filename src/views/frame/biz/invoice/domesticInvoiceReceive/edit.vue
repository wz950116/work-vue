...
export default {
  name: 'domesticInvoiceReceiveEdit',
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/invoice/domesticReceive/get',
          save: '/api/invoice/domesticReceive/save',
          update: '/api/invoice/domesticReceive/update'
        },
        apiData: {
          view(param) {
        ...
        formData: {
          part1: {
            titleName: 'invoice.domesticInvoiceReceive.group.editPart1',
            content: [
              // 单据号
              {
              ...
              // 不含税金额
              {
                label: 'invoice.domesticInvoiceReceive.form.excludeTaxAmount',
              ...
              // 税额
              {
                label: 'invoice.domesticInvoiceReceive.form.taxAmount',
                prop: 'taxAmount',
                element: 'input-formatter',
                validate: [
                  {
              ...
              // 币种
              {
                label: 'invoice.domesticInvoiceReceive.form.currency',
                prop: 'currency',
                element: 'base-select',
        ...
        tabs: [
          {
            ...
            name: 'invoiceDomReceDetailDtoList',
            label: 'invoice.domesticInvoiceReceive.tab.invoiceDetailInfoTab',
