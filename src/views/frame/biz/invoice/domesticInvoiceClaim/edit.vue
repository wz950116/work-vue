...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/invoice/domesticClaim/get',
          save: '/api/invoice/domesticClaim/save',
          update: '/api/invoice/domesticClaim/update'
        },
        apiData: {
          view(param) {
        ...
        topButtons: [
          ...
          {
            iconName: '线性-选择文件',
            name: 'biz.btn.selectInvoiceDomesticReceive',
            isShow: ['add'],
            event: 'set',
            component: () => import('../invoiceDialog/domesticReceiveDetailDialog.vue'),
        ...
        formData: {
          part1: {
            ...
            content: [
              ...
              // 客户
              {
                label: 'invoice.domesticInvoiceClaim.form.customerNo',
                prop: 'customerNo',
                element: 'base-select',
                validate: [
                  {
              ...
              // 认领数量
              {
                label: 'invoice.domesticInvoiceClaim.form.claimQuantity',
                prop: 'claimQuantity',
                ...
                event: {
                  change: this.claimQuantityChange
                }
              },
              {},
              {},
              // 发票价格（不含税）
              {
                label: 'invoice.domesticInvoiceClaim.form.excludeTaxPrice',
              ...
              // 发票金额（不含税）
              {
                label: 'invoice.domesticInvoiceClaim.form.excludeTaxAmount',
              ...
              // 税率
              {
                label: 'invoice.domesticInvoiceClaim.form.taxRate',
                prop: 'taxRate',
                element: 'input-formatter',
                validate: [
                  {
              ...
              // 税额
              {
                label: 'invoice.domesticInvoiceClaim.form.taxAmount',
                prop: 'taxAmount',
                element: 'input-formatter',
                validate: [
                  {
              ...
              // 发票价格（含税）
              {
                label: 'invoice.domesticInvoiceClaim.form.includeTaxPrice',
              ...
              // 发票金额（含税）
              {
                label: 'invoice.domesticInvoiceClaim.form.includeTaxAmount',
              ...
              // 币种
              {
                label: 'invoice.domesticInvoiceClaim.form.currency',
                prop: 'currency',
                element: 'base-select',
        ...
        tabs: [
          {
            ...
            name: 'invoiceDomClaimDetailDtoList',
            label: 'invoice.domesticInvoiceClaim.tab.claimDetailInfoTab',
            component: () => import('./claimDetailInfoTab.vue'),
            required: true
          }
        ]
      }
  ...
  methods: {
    ...
    selectInvoiceDomesticReceiveCallback(param) {
      ...
      this.$refs.qmEdit.$refs.qmRouteEdit.editForm['receiveDetailNo'] = param.receiveDetailNo
      this.$refs.qmEdit.$refs.qmRouteEdit.editForm['claimQuantity'] = '0'
    ...
    claimQuantityChange(val) {
      this.$refs.qmEdit.$refs.qmRouteEdit.editForm['claimQuantity'] = Number(val) + ''
    ...
    clearReceiveInfo() {
      ...
      this.$refs.qmEdit.$refs.qmRouteEdit.editForm['receiveDetailNo'] = ''
      this.$refs.qmEdit.$refs.qmRouteEdit.editForm['claimQuantity'] = ''
    ...
    clearClaimDetailInfo() {
      this.$refs.qmEdit.$refs.qmRouteEdit.$refs.invoiceDomClaimDetailDtoList[0].$refs.tab.tableData = []
    }
  }
}
</script>
