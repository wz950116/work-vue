        ...
        topBar: [
          {
            ...
            component: () => import('@/views/frame/biz/spot/dialog/invoice/chooseLotProductSD.vue'),
  ...
  methods: {
    ...
    handleCloseDialog(params) {
      ...
      params.forEach((row, index) => {
        ...
        this.$refs.tab.tableData[_index]['applyQuantity'] = row.rmnMemQty
        ...
        this.$refs.tab.tableData[_index]['includeTaxPrice'] = row.estimatedPrice
        this.$refs.tab.tableData[_index]['includeTaxAmount'] = ''
        this.$refs.tab.tableData[_index]['remark'] = ''
        this.$refs.tab.tableData[_index]['relateBillNo'] = row.lotNo
        this.$refs.tab.tableData[_index]['relateBillDetailNo'] = row.productDetailNo
        this.$refs.tab.tableData[_index]['relateBillType'] = 'CON_SL_INFO'
      })
      // 后过滤
      const newData = []
