    ...
    return {
      form: {
        listQuery: {
          ...
          defaultSortString: 'invoiceDate.desc, confirmNo.desc'
        },
        formData: [
          {
            type: 'date',
      ...
      mainData: {
        api: {
          cancelAudit: '/api/invoice/domesticConfirm/cancelAudit',
          search: '/api/invoice/domesticConfirm/list',
          doDelete: '/api/invoice/domesticConfirm/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          // 修改
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticInvoiceConfirmUpdate',
                params: {
                  type: 'update',
            ...
            validateApi(row) {
              return {
                url: '/api/invoice/domesticConfirm/validatedApi',
                data: row.confirmNo
              }
            }
          },
          ...
          // 查看
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticInvoiceConfirmView',
                params: {
                  type: 'view',
                  id: currentRow.confirmNo,
                  back: 'domesticInvoiceConfirm'
