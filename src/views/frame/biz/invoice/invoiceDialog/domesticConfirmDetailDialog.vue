...
export default {
  data() {
    return {
      dialog: {
        titleName: this.$t('invoice.domesticInvoiceConfirm.popup.productDetailList'),
        moreShowFlg: false,
        ...
        formData: [
          ...
          {
            label: 'invoice.domesticInvoiceConfirm.form.productCode',
            prop: 'productCode',
            element: 'base-select',
            attrs: {
              data: 'DD_PRODUCT',
          ...
          {
            label: 'invoice.domesticInvoiceConfirm.form.invoiceName',
            prop: 'invoiceName',
            element: 'input-validate',
            attrs: {
              disabled: false,
        ...
        mainData: {
          api: {
            search: '/api/invoice/domConfDeta/listForVerification'
          },
          apiData: {
            search(listQuery) {
              const newListQuery = Object.assign(listQuery, {
                defaultSortString: 'invoiceDate.asc, confirmNo.asc'
              })
              return newListQuery
            }
          },
          ...
          table: {
            ...
            cols: [
              // 单据号
              {
                label: 'invoice.domesticInvoiceConfirm.list.confirmNo',
                prop: 'confirmNo',
                width: 200,
                align: 'left',
                sortable: 'custom'
              ...
              // 发票号
              {
                label: 'invoice.domesticInvoiceConfirm.list.invoiceNo',
                prop: 'invoiceNo',
                width: 200,
                align: 'left',
                sortable: 'custom'
              ...
              // 发票日期
              {
                label: 'invoice.domesticInvoiceConfirm.list.invoiceDate',
                prop: 'invoiceDate',
                format: {
                  dict: 'yyyy-MM-dd',
                  func: 'dateFormat'
              ...
              // 供应商
              {
                label: 'invoice.domesticInvoiceConfirm.list.customerName',
                prop: 'customerName',
                width: 300,
                align: 'left',
                sortable: 'custom'
              ...
              // 币种
              {
                label: 'invoice.domesticInvoiceConfirm.list.currency',
                prop: 'currency',
                format: {
              ...
              // 未核销数量
              {
                label: 'invoice.domesticInvoiceConfirm.list.unVerificatQuantity',
              ...
              // 核销状态
              {
                label: 'invoice.domesticInvoiceConfirm.list.verificatStatus',
