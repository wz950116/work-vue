  ...
  data() {
    return {
      edit: {
        ...
        formData: {
          part1: {
            titleName: 'invoice.foreignInvoiceReceive.group.provisionalEditPart1',
            content: [
              {
      ...
      if (params) {
        ...
        for (let i = 0; i < params.length; i++) {
          if (params[i].lotNo !== lotInfo.lotNo) {
            this.$notify(notifyInfo({ msg: this.$t('invoice.foreignInvoiceReceive.msg.chooseLotProduct') }))
            return
          }
