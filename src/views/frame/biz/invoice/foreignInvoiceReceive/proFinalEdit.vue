      ...
      edit: {
        ...
        topButtons: [
          ...
          },
          {
            ...
            event: 'set',
            component: () => import('@/views/frame/biz/invoice/invoiceDialog/invoiceSelect.vue'),
        ...
        formData: {
          part1: {
            titleName: 'invoice.foreignInvoiceReceive.group.proFinalEditPart1',
            content: [
              {
              ...
              {
                label: 'invoice.foreignInvoiceReceive.form.provisionalNo',
                prop: 'prevInvoiceNo',
                element: 'input-validate',
                validate: [
                  {
              ...
              {
                label: 'invoice.foreignInvoiceReceive.form.provisionalAmount',
              ...
              {
                label: 'invoice.foreignInvoiceReceive.form.diffAmount',
                prop: 'diffAmount',
                element: 'input-formatter',
                attrs: {
                  disabled: true,
