...
export default {
  name: 'foreignInvoiceMakeVerEdit',
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/invoice/forMakeVer/get',
          save: '/api/invoice/forMakeVer/save',
          update: '/api/invoice/forMakeVer/update'
        },
        apiData: {
          view(param) {
        ...
        topButtons: [
          ...
          },
          {
            ...
            getParam(data) {
              return {
                makeVerificatNo: data.uk || data.makeVerificatNo
              }
            },
            event: 'print',
          ...
          {
            iconName: '线性-选择文件',
            name: 'biz.btn.selectInvoiceForMake',
            isShow: ['add'],
            event: 'set',
        ...
        formData: {
          part1: {
            titleName: 'invoice.foreignInvoiceMakeVer.group.editPart1',
            content: [
              // 单据号
              {
              ...
              // 销售批次
              {
                label: 'invoice.foreignInvoiceMakeVer.form.lotNo',
                prop: 'lotNo',
                element: 'input-validate',
                validate: [
                  {
              ...
              // 核销金额
              {
                label: 'invoice.foreignInvoiceMakeVer.form.includeTaxAmount',
              ...
              // 币种
              {
                label: 'invoice.foreignInvoiceMakeVer.form.currency',
                prop: 'currency',
                element: 'base-select',
        ...
        tables: [
          {
            ...
            name: 'invoiceForMkVerJoDeDtoList',
            label: 'invoice.foreignInvoiceMakeVer.tab.makeVerJoinDetailInfoTab',
            component: () => import('./makeVerJoinDetailInfoTab.vue'),
            required: true
          },
          {
            isShow: ['add', 'update', 'view', 'assist', 'audit'],
            name: 'invoiceForMkVerDeDtoList',
            label: 'invoice.foreignInvoiceMakeVer.tab.makeVerDetailInfoTab',
            component: () => import('./makeVerDetailInfoTab.vue'),
            required: true
          }
        ]
      }
  ...
  methods: {
    ...
    selectForeignReceiveDetailCallback(param) {
      ...
      let arrayInvoice = []
      let arrayCurrency = []
      let productList = this.$refs.qmEdit.$refs.qmRouteEdit.$refs.invoiceForMkVerJoDeDtoList[0].$refs.tab.tableData
    ...
    clearVerificatJoinDetailInfo() {
      this.$refs.qmEdit.$refs.qmRouteEdit.$refs.invoiceForMkVerJoDeDtoList[0].$refs.tab.tableData = []
    },
    // 清空收票核销明细信息
    clearVerificatDetailInfo() {
      this.$refs.qmEdit.$refs.qmRouteEdit.$refs.invoiceForMkVerDeDtoList[0].$refs.tab.tableData = []
    }
  }
}
</script>
