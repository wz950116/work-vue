  ...
  data() {
    return {
      tab: {
        ...
        api: {
          search: '/api/invoice/forMkVerJoDe/listByVerificatNo'
        },
        apiData: {
          search(param) {
        ...
        table: {
          ...
          cols: [
            // 商品
            {
              label: 'invoice.foreignInvoiceMakeVer.list.productCode',
              prop: 'productName',
              width: 200,
              align: 'left',
              required: true
            ...
            // 毛重
            {
              label: 'invoice.foreignInvoiceMakeVer.list.grossWeight',
              prop: 'grossWeight',
              width: '150',
              required: true,
              format: {
            ...
            // 净重
            {
              label: 'invoice.foreignInvoiceMakeVer.list.netWeight',
              prop: 'netWeight',
              width: '150',
              required: true,
              format: {
            ...
            // 干重
            {
              label: 'invoice.foreignInvoiceMakeVer.list.dryWeight',
              prop: 'dryWeight',
              width: '150',
              format: {
                func: 'weight'
            ...
            // 发票单价
            {
              label: 'invoice.foreignInvoiceMakeVer.list.invoicePrice',
              prop: 'invoicePrice',
              width: '150',
              required: true,
              format: {
            ...
            // 发票金额
            {
              label: 'invoice.foreignInvoiceMakeVer.list.invoiceAmount',
              prop: 'invoiceAmount',
              width: '150',
              required: true,
              format: {
            ...
            // 核销数量
            {
              label: 'invoice.foreignInvoiceMakeVer.list.verificatQuantity',
