  ...
  data() {
    return {
      tab: {
        ...
        api: {
          search: '/api/invoice/forMkVerDe/listByVerificatNo'
        },
        apiData: {
          search(param) {
        ...
        topBar: [
          {
            ...
            component: () => import('@/views/frame/biz/invoice/dialog/outProductForMakeVer.vue'),
        ...
        table: {
          ...
          cols: [
            // 出库单号
            {
              label: 'invoice.foreignInvoiceMakeVer.list.outBillNo',
              prop: 'outBillNo',
              width: 150,
              required: true
            },
            // 出库商品明细
            {
              label: 'invoice.foreignInvoiceMakeVer.list.outProductNo',
              prop: 'outProductNo',
              width: 150
            },
            // 商品
