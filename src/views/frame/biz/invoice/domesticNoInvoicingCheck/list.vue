...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/invoice/domNoInvoicingCheck/list'
        },
        apiData: {
          search(param) {
            return param
        ...
        table: {
          ...
          cols: [
            ...
            {
              label: 'spot.contractLot.form.invoicedQty',
              prop: 'measurementQuantity',
              align: 'right',
              width: '120',
              format: {
            ...
            {
              label: 'spot.contractLot.form.excMemQty',
              prop: 'excMemQty',
              align: 'right',
              width: '120',
              format: {
            ...
            {
              label: 'spot.contractLot.form.unInvoicedQty',
              prop: 'rmnMemQty',
              align: 'right',
              width: '120',
              format: {
