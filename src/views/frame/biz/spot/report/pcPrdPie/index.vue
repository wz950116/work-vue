  ...
  methods: {
    ...
    getList() {
      request({
        ...
        window.onresize = chartPrd.resize
        chartPrd.setOption({
          title: { text: '品种采购额占比' },
          toolbox: {
            show: true,
          ...
          tooltip: {
            ...
            formatter(params, ticket, callback) {
              ...
              return params.data.name +
                '<br/>采购额: ' + fundConfirmAmount + ' 万元' +
                '<br/>采购额占比: ' + params.percent + '%' +
                '<br/>发票额: ' + invoiceAmt + ' 万元' +
                '<br/>采购量: ' + whChkQty + ' ' + params.data.measurementUnitName
            }
          },
          series: [
            {
