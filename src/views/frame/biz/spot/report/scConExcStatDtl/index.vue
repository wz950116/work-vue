...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/contract/scReport/listConExcDtl',
          export: '/api/contract/scReport/listConExcDtl'
        },
        initSearch: true,
        isTopBar: true,
        topBar: [
        ...
        table: {
          ...
          cols: [
            ...
            {
              label: 'spot.contractLot.report.fundAmtRec',
              prop: 'fundAmt',
              summary: true,
              align: 'right',
              width: '120',
