...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/contract/scReport/listReportExcStat',
          export: '/api/contract/scReport/listReportExcStat'
        },
        initSearch: true,
        isTopBar: true,
        topBar: [
        ...
        table: {
          ...
          cols: [
            ...
            {
              label: 'spot.contractLot.report.whOutChkQty',
              prop: 'whChkQty',
              summary: true,
              align: 'right',
              width: '120',
