...
export default {
  name: 'domesticPurchaseContractEdit',
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/contract/domesticPcInfo/get',
          save: '/api/contract/domesticPcInfo/save',
  ...
  methods: {
    ...
    getUpdateApi(type) {
      switch (type) {
        case 'save':
          return '/api/contract/domesticPcInfo/save'
        case 'update':
          return '/api/contract/domesticPcInfo/update'
        case 'copy':
          return '/api/contract/domesticPcInfo/save'
      }
    },
    ...
    viewUpdate() {
      ...
      this.gotoPage('domesticPurchaseContractUpdate', {
        type: 'update',
    ...
    viewCopy() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('domesticPurchaseContractCopy', {
        type: 'copy',
        contractNo: editForm.contractNo
      })
    },
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/contract/domesticPcInfo/remove',
            method: 'post',
            data: {
    ...
    viewChange() {
      ...
      this.openPage('domPurchaseContractChangeAdd', {
        type: 'add',
        contractNo: editForm.contractNo
      })
    },
    viewArchive() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.closeContractConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/contract/domesticPcInfo/achive',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    doHistory() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('domPurchaseContractHistory', {
        contractNo: editForm.contractNo
      })
    },
    archiveShow() {
    ...
    closePage(param) {
      const backName = this.$route.params.back ? this.$route.params.back : 'domesticPurchaseContract'
