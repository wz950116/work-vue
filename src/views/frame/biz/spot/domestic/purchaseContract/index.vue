    ...
    return {
      ...
      mainData: {
        api: {
          ...
          search: '/api/contract/domesticPcInfo/list',
          export: '/api/contract/domesticPcInfo/export',
          doDelete: '/api/contract/domesticPcInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          {
            ...
            routeInfo() {
              return {
                name: 'domesticPurchaseContractAdd',
                params: {
                  type: 'add',
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticPurchaseContractCopy',
                params: {
                  type: 'copy',
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticPurchaseContractUpdate',
                params: {
                  type: 'update',
                  contractNo: currentRow.contractNo,
                  back: this.$refs.qmForm.$route.name
            ...
            validateApi(row) {
              return {
                url: '/api/contract/domesticPcInfo/validatedApi',
                data: row.contractNo
              }
            }
          },
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticPurchaseContractView',
                params: {
                  type: 'view',
                  contractNo: currentRow.contractNo,
                  back: this.$refs.qmForm.$route.name
  ...
  methods: {
    ...
    openPageLotAdd() {
      ...
      request({
        ...
        if (response.status) {
          this.openPage('domPurchaseLotAdd', {
            type: 'add',
            preBillNo: currentRow.contractNo,
            preBillType: 'CON_PC_INFO',
            back: 'domesticPurchaseContract'
          })
        }
      })
    },
