...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/contract/domesticPlcInfo/get',
          save: '/api/contract/domesticPlcInfo/save',
          update: '/api/contract/domesticPlcInfo/update'
        },
        apiData: {
          view(param) {
        ...
        topButtons: [
          ...
          },
          {
            ...
            isShow: ['add'],
            event: 'set',
            component: () => import('../../components/domestic/chooseLotInfoPl.vue'), // 组件
  ...
  methods: {
    ...
    loadFromLot(lotNo) {
      request({
        url: '/api/contract/domesticPlInfo/get',
        method: 'post',
        data: {
        ...
        if (response.data) {
          ...
          lotInfo.effectiveDate = param.effectiveDate
          lotInfo.id = null
    ...
    viewUpdate() {
      ...
      this.gotoPage('domPurchaseLotChangeUpdate', {
        type: 'update',
    ...
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/contract/domesticPlcInfo/remove',
            method: 'post',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
              funcOperation: this.$t('biz.btn.search'),
    ...
    closePage(param) {
      const backName = this.$route.params.back ? this.$route.params.back : 'domPurchaseLotChange'
