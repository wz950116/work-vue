    ...
    return {
      ...
      mainData: {
        api: {
          ...
          search: '/api/contract/domesticPlcInfo/list',
          export: '/api/contract/domesticPlcInfo/export',
          doDelete: '/api/contract/domesticPlcInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domPurchaseLotChangeUpdate',
                params: {
                  type: 'update',
            ...
            validateApi(row) {
              return {
                url: '/api/contract/domesticPlcInfo/validatedApi',
                data: row.changeNo
              }
            }
          },
