    ...
    return {
      ...
      mainData: {
        api: {
          ...
          export: '/api/domesticContract/slcInfo/export',
          doDelete: '/api/domesticContract/slcInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          {
            ...
            routeInfo() {
              return {
                name: 'domesticSalesLotChangeAdd',
                params: {
                  type: 'add',
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticSalesLotChangeUpdate',
                params: {
                  type: 'update',
            ...
            validateApi(row) {
              return {
                url: '/api/domesticContract/slcInfo/validatedApi',
                data: row.changeNo
              }
            }
          },
