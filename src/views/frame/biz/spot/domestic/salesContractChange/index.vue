...
<script>
export default {
  name: 'domesticSalesContractChange',
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/domesticContract/sccInfo/list',
          export: '/api/domesticContract/sccInfo/export',
          doDelete: '/api/domesticContract/sccInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticSalesContractChangeUpd',
                params: {
                  type: 'update',
            ...
            validateApi(row) {
              return {
                url: '/api/domesticContract/sccInfo/validatedApi',
                data: row.changeNo
              }
            }
          },
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticSalesContractChangeView',
                params: {
                  type: 'view',
                  changeNo: currentRow.changeNo,
                  back: this.$refs.qmForm.$route.name
