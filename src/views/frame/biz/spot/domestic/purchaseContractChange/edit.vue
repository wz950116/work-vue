...
export default {
  name: 'domPurchaseContractChangeEdit',
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/contract/domesticPccInfo/get',
          save: '/api/contract/domesticPccInfo/save',
          update: '/api/contract/domesticPccInfo/update'
        },
        apiData: {
          view(param) {
        ...
        topButtons: [
          ...
          },
          {
            ...
            isShow: ['add'],
            event: 'set',
            component: () => import('../../components/domestic/chooseContractInfoPc.vue'), // 组件
  ...
  methods: {
    ...
    loadFromContract(contractNo) {
      request({
        url: '/api/contract/domesticPcInfo/get',
        method: 'post',
        data: {
    ...
    viewUpdate() {
      ...
      this.gotoPage('domPurchaseContractChangeUpdate', {
        type: 'update',
    ...
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/contract/domesticPccInfo/remove',
            method: 'post',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
              funcOperation: this.$t('biz.btn.search'),
    ...
    closePage(param) {
      const backName = this.$route.params.back ? this.$route.params.back : 'domesticPurchaseContractChange'
