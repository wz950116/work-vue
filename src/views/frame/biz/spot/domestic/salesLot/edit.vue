...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          pre: {
            DOM_CON_SC_INFO: '/api/domesticContract/scInfo/get'
          },
          view: '/api/domesticContract/slInfo/get',
          save: '/api/domesticContract/slInfo/save',
  ...
  methods: {
    ...
    getUpdateApi(type) {
      switch (type) {
        case 'save':
          return '/api/domesticContract/slInfo/save'
        case 'update':
          return '/api/domesticContract/slInfo/update'
        case 'copy':
          return '/api/domesticContract/slInfo/save'
      }
    },
    ...
    closeLv2Dialog(param) {
      ...
      this.loadSubMarginList({ billType: 'DOM_CON_SC_INFO', billNo: contract.contractNo }, marginRuleList, '/api/contract/conMarginRule/getByContractNo')
    ...
    viewUpdate() {
      ...
      this.gotoPage('domesticSalesLotUpdate', {
        type: 'update',
    ...
    viewCopy() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('domesticSalesLotCopy', {
        type: 'copy',
        lotNo: editForm.lotNo
      })
    },
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/domesticContract/slInfo/remove',
            method: 'post',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
              funcOperation: this.$t('biz.btn.search'),
    ...
    closePage(param) {
      const backName = this.$route.params.back ? this.$route.params.back : 'domesticSalesLot'
