...
export default {
    ...
    return {
      edit: {
        ...
        api: {
          ...
          view: '/api/contract/domesticPlInfo/get',
          save: '/api/contract/domesticPlInfo/save',
        ...
        topButtons: [
          ...
          },
          {
            ...
            isShow: ['add'],
            event: 'set',
            component: () => import('../../components/domestic/chooseContractProductPc.vue'), // 组件
  ...
  methods: {
    ...
    getUpdateApi(type) {
      switch (type) {
        case 'save':
          return '/api/contract/domesticPlInfo/save'
        case 'update':
          return '/api/contract/domesticPlInfo/update'
        case 'copy':
          return '/api/contract/domesticPlInfo/save'
      }
    },
    ...
    closeLv2Dialog(param) {
      ...
      this.loadSubMarginList({ billType: 'CON_DOMESTIC_PC_INFO', billNo: contract.contractNo }, marginRuleList, '/api/contract/conMarginRule/getByContractNo')
    ...
    viewUpdate() {
      ...
      this.gotoPage('domPurchaseLotUpdate', {
        type: 'update',
    ...
    viewCopy() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('domPurchaseLotCopy', {
        type: 'copy',
        lotNo: editForm.lotNo
      })
    },
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/contract/domesticPlInfo/remove',
            method: 'post',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
              funcOperation: this.$t('biz.btn.search'),
    ...
    openModifyAdd() {
      ...
      request({
        url: '/api/contract/domesticPlInfo/checkChangeAble',
        method: 'post',
        data: {
          funcModule: this.$t('route.' + this.$route.meta.title),
          funcOperation: this.$t('biz.btn.search'),
        ...
        if (response.status) {
          this.openPage('domPurchaseLotChangeAdd', {
            type: 'add',
            lotNo: editForm.lotNo
          })
        }
    ...
    viewArchive() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.closeLotConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/contract/domesticPlInfo/achive',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    goodFinish() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.lotGoodFinishConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/contract/domesticPlInfo/goodFinish',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    fundFinish() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.lotFundFinishConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/contract/domesticPlInfo/fundFinish',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    invoFinish() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.lotInvoFinishConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/contract/domesticPlInfo/invoFinish',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    doHistory() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('domPurchaseLotHistory', {
        lotNo: editForm.lotNo
      })
    },
    archiveShow() {
    ...
    closePage(param) {
      const backName = this.$route.params.back ? this.$route.params.back : 'domesticPurchaseLot'
