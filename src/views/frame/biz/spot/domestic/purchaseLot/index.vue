    ...
    <template v-if="true||route.name === $options.name || ( $route.meta && $route.meta.componentName === $options.name)">
      <qm-table-array ref="qmTable" :mainData="mainData">
        <template slot='contractNo' slot-scope='scope'>
          <router-link :to="{name: 'domesticPurchaseContractView', params: {type: 'view',back: 'domesticPurchaseLot','contractNo':scope.row.contractNo }}">{{
    ...
    return {
      ...
      mainData: {
        api: {
          ...
          export: '/api/contract/domesticPlInfo/export',
          doDelete: '/api/contract/domesticPlInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            validateApi(row) {
              return {
                url: '/api/contract/domesticPlInfo/validatedApi',
                data: row.lotNo
              }
            }
          },
