...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/domesticContract/scInfo/list',
          export: '/api/domesticContract/scInfo/export',
          doDelete: '/api/domesticContract/scInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticSalesContractCopy',
                params: {
                  type: 'copy',
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticSalesContractUpdate',
                params: {
                  type: 'update',
                  contractNo: currentRow.contractNo,
                  back: this.$refs.qmForm.$route.name
            ...
            validateApi(row) {
              return {
                url: '/api/domesticContract/scInfo/validatedApi',
                data: row.contractNo
              }
            }
          },
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticSalesContractView',
                params: {
                  type: 'view',
                  contractNo: currentRow.contractNo,
                  back: this.$refs.qmForm.$route.name
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'domesticSalesContractChangeAdd',
                params: {
                  type: 'add',
                  contractNo: currentRow.contractNo,
                  back: this.$refs.qmForm.$route.name
  ...
  methods: {
    doAchive() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.closeContractConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/domesticContract/scInfo/achive',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    doHistory() {
      ...
      this.openPage('domesticSalesContractHistory', {
        contractNo: currentRow.contractNo
      })
    },
    archiveShow() {
    ...
    openPageLotAdd() {
      ...
      request({
        url: '/api/domesticContract/scInfo/checkAddLotAble',
        method: 'post',
        data: {
          funcModule: this.$t('route.' + this.$route.meta.title),
          funcOperation: this.$t('biz.btn.search'),
        ...
        if (response.status) {
          this.openPage('domesticSalesLotAdd', {
            type: 'add',
            preBillNo: currentRow.contractNo,
            preBillType: 'DOM_CON_SC_INFO',
            back: 'domesticSalesContract'
          })
        }
      })
    },
