...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/domesticContract/scInfo/get',
          save: '/api/domesticContract/scInfo/save',
  ...
  methods: {
    ...
    getUpdateApi(type) {
      switch (type) {
        case 'save':
          return '/api/domesticContract/scInfo/save'
        case 'update':
          return '/api/domesticContract/scInfo/update'
        case 'copy':
          return '/api/domesticContract/scInfo/save'
      }
    },
    ...
    viewUpdate() {
      ...
      this.gotoPage('domesticSalesContractUpdate', {
        type: 'update',
    ...
    viewCopy() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('domesticSalesContractCopy', {
        type: 'copy',
        contractNo: editForm.contractNo
      })
    },
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/domesticContract/scInfo/remove',
            method: 'post',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
              funcOperation: this.$t('biz.btn.search'),
    ...
    viewChange() {
      ...
      this.openPage('domesticSalesContractChangeAdd', {
        type: 'add',
        contractNo: editForm.contractNo
      })
    },
