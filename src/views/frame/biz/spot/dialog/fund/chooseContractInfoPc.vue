...
export default {
  data() {
    return {
      dialog: {
        titleName: this.$t('spot.contractLot.popup.chooseContractInfoPc'),
        moreShowFlg: false,
        initType: 'param',
        ...
        mainData: {
          api: {
            search: '/api/contract/pcInfo/listChooseForFund'
          },
          apiData: {
            search(param) {
          ...
          table: {
            ...
            cols: [
              ...
              {
                label: 'spot.contractLot.form.contractAmount',
                prop: 'originalAmount',
                align: 'right',
                width: '120',
                format: {
              ...
              {
                label: 'spot.contractLot.form.fundApplyAmount',
                prop: 'excAmt',
                align: 'right',
                format: {
                  func: 'money'
