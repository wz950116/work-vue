...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/contract/psInfo/list',
          export: '/api/contract/psInfo/export',
          doDelete: '/api/contract/psInfo/remove',
          cancelAudit: '/api/contract/psInfo/cancelAudit'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            validateApi(row) {
              return {
                url: '/api/contract/psInfo/validatedApi',
