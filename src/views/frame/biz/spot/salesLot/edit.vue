...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          pre: {
            CON_SC_INFO: '/api/contract/scInfo/get'
          },
          view: '/api/contract/slInfo/get',
          save: '/api/contract/slInfo/save',
  ...
  methods: {
    ...
    getUpdateApi(type) {
      switch (type) {
        case 'save':
          return '/api/contract/slInfo/save'
        case 'update':
          return '/api/contract/slInfo/update'
        case 'copy':
          return '/api/contract/slInfo/save'
      }
    },
    ...
    closeLv2Dialog(param) {
      ...
      this.loadSubMarginList({ billType: 'CON_SC_INFO', billNo: contract.contractNo }, marginRuleList, '/api/contract/conMarginRule/getByContractNo')
    ...
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/contract/slInfo/remove',
            method: 'post',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
              funcOperation: this.$t('biz.btn.search'),
    ...
    openModifyAdd() {
      ...
      request({
        url: '/api/contract/slInfo/checkChangeAble',
        method: 'post',
        data: {
          funcModule: this.$t('route.' + this.$route.meta.title),
          funcOperation: this.$t('biz.btn.search'),
        ...
        if (response.status) {
          this.openPage('salesLotChangeAdd', {
            type: 'add',
            lotNo: editForm.lotNo
          })
        }
    ...
    viewArchive() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.closeLotConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/contract/slInfo/achive',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    goodFinish() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.lotGoodFinishConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/contract/slInfo/goodFinish',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    fundFinish() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.lotFundFinishConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/contract/slInfo/fundFinish',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    invoFinish() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.lotInvoFinishConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/contract/slInfo/invoFinish',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
