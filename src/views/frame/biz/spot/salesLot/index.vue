...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/contract/slInfo/list',
          export: '/api/contract/slInfo/export',
          doDelete: '/api/contract/slInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            validateApi(row) {
              return {
                url: '/api/contract/slInfo/validatedApi',
                data: row.lotNo
              }
            }
          },
