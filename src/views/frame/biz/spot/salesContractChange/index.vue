...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/contract/sccInfo/list',
          export: '/api/contract/sccInfo/export',
          doDelete: '/api/contract/sccInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'salesContractChangeUpdate',
                params: {
                  type: 'update',
            ...
            validateApi(row) {
              return {
                url: '/api/contract/sccInfo/validatedApi',
                data: row.changeNo
              }
            }
          },
