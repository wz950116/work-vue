...
export default {
  ...
  methods: {
    ...
    viewUpdate() {
      ...
      this.gotoPage('purchaseContractUpdate', {
        type: 'update',
    ...
    viewCopy() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('purchaseContractCopy', {
        type: 'copy',
        contractNo: editForm.contractNo
      })
    },
    ...
    viewChange() {
      ...
      this.openPage('purchaseContractChangeAdd', {
        type: 'add',
        contractNo: editForm.contractNo
      })
    },
    ...
    closePage(param) {
      const backName = this.$route.params.back ? this.$route.params.back : 'purchaseContract'
