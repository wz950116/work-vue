...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/externalContract/scInfo/list',
          export: '/api/externalContract/scInfo/export',
          doDelete: '/api/externalContract/scInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'externalSalesContractCopy',
                params: {
                  type: 'copy',
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'externalSalesContractUpdate',
                params: {
                  type: 'update',
                  contractNo: currentRow.contractNo,
                  back: this.$refs.qmForm.$route.name
            ...
            validateApi(row) {
              return {
                url: '/api/externalContract/scInfo/validatedApi',
                data: row.contractNo
              }
            }
          },
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'externalSalesContractView',
                params: {
                  type: 'view',
                  contractNo: currentRow.contractNo,
                  back: this.$refs.qmForm.$route.name
  ...
  methods: {
    ...
    openPageLotAdd() {
      ...
      request({
        url: '/api/externalContract/scInfo/checkAddLotAble',
        method: 'post',
        data: {
          funcModule: this.$t('route.' + this.$route.meta.title),
          funcOperation: this.$t('biz.btn.search'),
        ...
        if (response.status) {
          this.openPage('extSalesLotAdd', {
            type: 'add',
            preBillNo: currentRow.contractNo,
            preBillType: 'EXT_CON_SC_INFO',
            back: 'externalSalesContract'
          })
        }
      })
    },
