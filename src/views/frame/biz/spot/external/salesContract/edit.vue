...
export default {
  name: 'externalSalesContractEdit',
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/externalContract/scInfo/get',
          save: '/api/externalContract/scInfo/save',
        ...
        formData: {
          part1: {
            ...
            content: [
              ...
              {
                label: 'spot.contractLot.form.isInternal',
                prop: 'isReverse',
                element: 'el-checkbox',
                default: '0',
                attrs: {
        ...
        tabs: [
          ...
          },
          {
            ...
            label: 'spot.contractLot.tab.paymentAgreementList',
  ...
  methods: {
    ...
    getUpdateApi(type) {
      switch (type) {
        case 'save':
          return '/api/externalContract/scInfo/save'
        case 'update':
          return '/api/externalContract/scInfo/update'
        case 'copy':
          return '/api/externalContract/scInfo/save'
      }
    },
    ...
    viewUpdate() {
      ...
      this.gotoPage('externalSalesContractUpdate', {
        type: 'update',
    ...
    viewCopy() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('externalSalesContractCopy', {
        type: 'copy',
        contractNo: editForm.contractNo
      })
    },
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/externalContract/scInfo/remove',
            method: 'post',
            data: {
    ...
    viewChange() {
      ...
      this.openPage('externalSalesContractChangeAdd', {
        type: 'add',
        contractNo: editForm.contractNo
      })
    },
    viewArchive() {
      ...
      this.$confirm(this.$t('spot.contractLot.msg.closeContractConfirmed'), this.$t('notify.title.warning'), {
        ...
        request({
          url: '/api/externalContract/scInfo/achive',
          method: 'post',
          data: {
            funcModule: this.$t('route.' + this.$route.meta.title),
            funcOperation: this.$t('biz.btn.search'),
    ...
    doHistory() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('extSalesContractHistory', {
        contractNo: editForm.contractNo
      })
    },
    archiveShow() {
    ...
    closePage(param) {
      const backName = this.$route.params.back ? this.$route.params.back : 'externalSalesContract'
