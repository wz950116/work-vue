...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/externalContract/slInfo/list',
          export: '/api/externalContract/slInfo/export',
          doDelete: '/api/externalContract/slInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            validateApi(row) {
              return {
                url: '/api/externalContract/slInfo/validatedApi',
                data: row.lotNo
              }
            }
          },
