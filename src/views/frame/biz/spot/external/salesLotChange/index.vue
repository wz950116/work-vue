...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/externalContract/slcInfo/list',
          export: '/api/externalContract/slcInfo/export',
          doDelete: '/api/externalContract/slcInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            validateApi(row) {
              return {
                url: '/api/externalContract/slcInfo/validatedApi',
                data: row.changeNo
              }
            }
          },
