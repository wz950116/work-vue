...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/externalContract/slcInfo/get',
          save: '/api/externalContract/slcInfo/save',
          update: '/api/externalContract/slcInfo/update'
        },
        apiData: {
          view(param) {
  ...
  methods: {
    ...
    closeLv2Dialog(param) {
      ...
      this.loadSubMarginList({ billType: 'EXT_CON_SL_INFO', billNo: param.lotNo }, marginRuleList, '/api/contract/conMarginRule/getByContractNo')
    },
    ...
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/externalContract/slcInfo/remove',
            method: 'post',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
              funcOperation: this.$t('biz.btn.search'),
