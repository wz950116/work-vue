...
export default {
  name: 'externalSalesContractChangeEdit',
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/externalContract/sccInfo/get',
          save: '/api/externalContract/sccInfo/save',
          update: '/api/externalContract/sccInfo/update'
        },
        apiData: {
          view(param) {
  ...
  methods: {
    ...
    loadFromContract(contractNo) {
      request({
        url: '/api/externalContract/scInfo/get',
        method: 'post',
        data: {
        ...
        if (response.data) {
          ...
          contractInfo.deliveryModeList = param.deliveryModeList
    ...
    closeLv2Dialog(param) {
      ...
      this.loadSubMarginList({ billType: 'EXT_CON_SC_INFO', billNo: param.contractNo }, marginRuleList, '/api/contract/conMarginRule/getByContractNo')
      // 赋值配货信息
    ...
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/externalContract/sccInfo/remove',
            method: 'post',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
              funcOperation: this.$t('biz.btn.search'),
