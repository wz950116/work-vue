      ...
      mainData: {
        ...
        topBar: [
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'extPurchaseContractUpdate',
                params: {
                  type: 'update',
                  contractNo: currentRow.contractNo,
                  back: this.$refs.qmForm.$route.name
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'extPurchaseContractChangeAdd',
                params: {
                  type: 'add',
                  contractNo: currentRow.contractNo,
                  back: this.$refs.qmForm.$route.name
  ...
  methods: {
    ...
    openPageLotAdd() {
      ...
      request({
        ...
        if (response.status) {
          this.openPage('extPurchaseLotAdd', {
            type: 'add',
            preBillNo: currentRow.contractNo,
            preBillType: 'CON_PC_INFO',
            back: 'extPurchaseContract'
          })
        }
      })
    },
