...
<script>
export default {
  name: 'extPurchaseContractChange',
  data() {
    return {
      ...
      mainData: {
        api: {
          ...
          export: '/api/contract/pccInfo/export',
          doDelete: '/api/contract/pccInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'extPurchaseContractChangeUpdate',
                params: {
                  type: 'update',
            ...
            validateApi(row) {
              return {
                url: '/api/contract/pccInfo/validatedApi',
                data: row.changeNo
              }
            }
          },
          ...
          },
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'extPurchaseContractChangeView',
                params: {
                  type: 'view',
                  changeNo: currentRow.changeNo,
                  back: this.$refs.qmForm.$route.name
