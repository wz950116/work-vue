...
export default {
      ...
      edit: {
        ...
        topButtons: [
          ...
          },
          {
            ...
            isShow: ['add'],
            event: 'set',
            component: () => import('../../components/external/chooseContractProductPc.vue'), // 组件
  ...
  methods: {
    ...
    closeLv2Dialog(param) {
      ...
      this.loadSubMarginList({ billType: 'CON_EXT_PC_INFO', billNo: contract.contractNo }, marginRuleList, '/api/contract/conMarginRule/getByContractNo')
    },
    ...
    viewUpdate() {
      ...
      this.gotoPage('extPurchaseLotUpdate', {
        type: 'update',
    ...
    viewCopy() {
      const editForm = toolUtil.getDataEditFromSelf(this)
      this.openPage('extPurchaseLotCopy', {
        type: 'copy',
        lotNo: editForm.lotNo
      })
    },
    ...
    closePage(param) {
      const backName = this.$route.params.back ? this.$route.params.back : 'extPurchaseLot'
