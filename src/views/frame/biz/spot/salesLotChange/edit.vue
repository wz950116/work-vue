  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/contract/slcInfo/get',
          save: '/api/contract/slcInfo/save',
          update: '/api/contract/slcInfo/update'
        },
        apiData: {
          view(param) {
  ...
  methods: {
    ...
    viewRemove() {
      ...
      this.$confirm(this.$t('biz.msg.confirmDelete'), this.$t('biz.msg.tip'), {
        ...
        .then(() => {
          request({
            url: '/api/contract/slcInfo/remove',
            method: 'post',
            data: {
              funcModule: this.$t('route.' + this.$route.meta.title),
              funcOperation: this.$t('biz.btn.search'),
