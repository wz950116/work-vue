...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/contract/slcInfo/list',
          export: '/api/contract/slcInfo/export',
          doDelete: '/api/contract/slcInfo/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          },
          {
            ...
            validateApi(row) {
              return {
                url: '/api/contract/slcInfo/validatedApi',
                data: row.changeNo
              }
            }
          },
