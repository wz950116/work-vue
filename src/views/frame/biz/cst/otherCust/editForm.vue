  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/cust/other/getByCode',
          save: '/api/cust/other/save',
        ...
        formData: {
          part1: {
            ...
            content: [
              {
                label: 'cst.otherCustomer.form.custNo',
                prop: 'custCode',
              ...
              {
                label: 'cst.otherCustomer.form.custFullName_CHS',
              ...
              {
                label: 'cst.otherCustomer.form.custFullName_EN',
                prop: 'custFullnameEn',
                element: 'input-validate',
                attrs: {
                  clearable: true,
              ...
              {
                label: 'cst.otherCustomer.form.custHeadline',
                prop: 'custHeadline',
                element: 'input-validate',
                validate: [
                  {
              ...
              {
                label: 'cst.otherCustomer.form.type',
                prop: 'typeCodeList',
                element: 'base-select',
                list: this.$t('datadict.custTypeOther'),
                validate: [
                  {
                    required: true,
                    trigger: 'change'
              ...
              {
                label: 'cst.otherCustomer.form.enterpriseType',
              ...
              {
                label: 'cst.otherCustomer.form.enterpriseForm',
              ...
              {
                label: 'cst.otherCustomer.form.licenceCode',
                prop: 'licenceCode',
                element: 'input-validate',
                attrs: {
                  clearable: true
              ...
              {
                type: 'date',
                label: 'cst.otherCustomer.form.licenceDueDate',
                prop: 'licenceDuedate',
                attrs: {
                  clearable: true,
                  format: 'yyyy-MM-dd',
          ...
          part2: {
            ...
            content: [
              {
                label: 'cst.otherCustomer.form.area',
                prop: 'areaCode',
                element: 'base-select',
                attrs: {
                  required: true,
              ...
              {
                label: 'cst.otherCustomer.form.address',
                prop: 'address',
                element: 'input-validate',
                attrs: {
                  clearable: true,
              ...
              {
                label: 'cst.otherCustomer.form.legalName',
                prop: 'legalName',
                element: 'input-validate',
                attrs: {
                  clearable: true,
              ...
              {
                label: 'cst.otherCustomer.form.registCapital',
                prop: 'registCapital',
              ...
              {
                label: 'cst.otherCustomer.form.officeAddress',
                prop: 'officeAddress',
                element: 'input-validate',
                attrs: {
                  clearable: true,
              ...
              {
                label: 'cst.otherCustomer.form.businessScale',
                prop: 'businessScale',
                element: 'base-select',
              ...
              {
                label: 'cst.otherCustomer.form.employees',
                prop: 'employees',
                element: 'input-formatter',
                attrs: {
                  type: 'num',
              ...
              {
                type: 'date',
                label: 'cst.otherCustomer.form.foundTime',
                prop: 'foundTime',
                attrs: {
                  clearable: true,
                  format: 'yyyy-MM-dd',
              ...
              {
                label: 'cst.otherCustomer.form.scopeBusiness',
                prop: 'scopeBusiness',
                element: 'el-input',
                attrs: {
                  clearable: true,
        ...
        tabs: [
          {
            ...
            name: 'cardInfoList',
            label: 'cst.otherCustomer.tab.cardInfo',
            component: () => import('./cardInfo.vue')
          },
          {
            isShow: ['add', 'update', 'assist', 'audit', 'view'],
            name: 'contactsList',
            label: 'cst.otherCustomer.tab.contactInfo',
            component: () => import('./contactInfo.vue')
          },
          {
            isShow: ['add', 'update', 'assist', 'audit', 'view'],
            name: 'bankInfoList',
            label: 'cst.otherCustomer.tab.accountInfo',
            component: () => import('./accountInfo.vue')
          },
          {
            isShow: ['add', 'update', 'assist', 'audit', 'view'],
            name: 'stackHoldList',
            label: 'cst.otherCustomer.tab.shareholdInfo',
            component: () => import('./shareholdInfo.vue')
          },
          {
            isShow: ['add', 'update', 'assist', 'audit', 'view'],
            name: 'billList',
            label: 'cst.otherCustomer.tab.taxInfo',
            component: () => import('./taxInfo.vue')
          },
          {
            isShow: ['view'],
            name: 'warehouseList',
            label: 'cst.otherCustomer.tab.creditInfo',
