...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          cancelAudit: '/api/fund/applyAdvTran/cancelAudit',
          search: '/api/fund/applyAdvTran/list',
          doDelete: '/api/fund/applyAdvTran/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          ...
          // 修改
          {
            ...
            routeInfo(currentRow) {
              return {
                name: 'advanceApplyTransferUpdate',
                params: {
                  type: 'update',
            ...
            validateApi(row) {
              return {
                url: '/api/fund/applyAdvTran/validatedApi',
                data: row.transferNo
              }
            }
          },
        ...
        table: {
          ...
          cols: [
            ...
            // 单据号
            {
              label: 'fund.advanceApplyTransfer.list.transferNo',
              prop: 'transferNo',
              width: 200,
              align: 'left',
              sortable: 'custom'
            ...
            // 转换日期
            {
              label: 'fund.advanceApplyTransfer.list.transferDate',
              prop: 'transferDate',
              format: {
                dict: 'yyyy-MM-dd',
                func: 'dateFormat'
            ...
            // 客户
            {
              label: 'fund.advanceApplyTransfer.list.customerName',
              prop: 'customerName',
              width: 300,
              align: 'left',
              sortable: 'custom'
            ...
            // 币种
            {
              label: 'fund.advanceApplyTransfer.list.currency',
              prop: 'currency',
              format: {
