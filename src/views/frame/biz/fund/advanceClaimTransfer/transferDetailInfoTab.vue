  ...
  data() {
    return {
      tab: {
        ...
        api: {
          search: '/api/fund/claimAdvTranDe/listByTransferNo'
        },
        apiData: {
          search(param) {
        ...
        table: {
          ...
          cols: [
            // 合同号
            {
              label: 'fund.advanceClaimTransfer.list.contractNo',
              prop: 'contractNo',
              width: 200,
              align: 'left'
            },
            // 批次号
            {
              label: 'fund.advanceClaimTransfer.list.lotNo',
              prop: 'lotNo',
              width: 200,
              align: 'left'
            },
            ...
            // 批次类型
            {
              label: 'fund.advanceClaimTransfer.list.lotType',
              prop: 'lotType',
              width: 80,
              align: 'center',
              format: {
            ...
            // 资金用途
            {
              label: 'fund.advanceClaimTransfer.list.fundUseType',
              prop: 'fundUseType',
              width: 100,
              align: 'center',
              element: 'base-select',
            ...
            // 商品
            {
              label: 'fund.advanceClaimTransfer.list.productName',
              prop: 'productName',
              width: 100,
              align: 'left'
            },
  ...
  methods: {
    ...
    validateAdd() {
      ...
      if (!this.editForm.contractNo) {
        this.$notify(notifyInfo({ msg: this.$t('请选择销售合同') }))
        return false
      }
