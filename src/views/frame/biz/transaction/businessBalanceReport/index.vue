...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          search: '/api/transaction/business/balanceReport',
          export: '/api/transaction/business/balanceReport'
        },
        apiData: {
          search(param) {
            return param
  ...
  methods: {
    ...
    handleInitCallback() {
      ...
      if (currency) {
        request({
          url: '/api/transaction/business/balanceSumInfo',
          method: 'POST',
