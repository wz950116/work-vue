...
export default {
  ...
  data() {
    return {
      form: {
        ...
        formData: [
          ...
          },
          {
            ...
            prop: 'billType',
            element: 'base-select',
            list: this.$t('datadict.financeBillType'),
            attrs: {
              disabled: false,
              clearable: true
            }
      ...
      mainData: {
        api: {
          search: '/api/transaction/finance/detailReport',
          export: '/api/transaction/finance/detailReport'
        },
        apiData: {
          search(param) {
            return param
        ...
        table: {
          ...
          cols: [
            ...
            // 单据类型
            {
              ...
              prop: 'billType',
              format: {
                dict: this.$t('datadict.financeBillType')
              },
              width: 100,
              align: 'center'
            },
  ...
  methods: {
    ...
    handleInitCallback() {
      ...
      if (currency) {
        request({
          url: '/api/transaction/finance/detailSumInfo',
          method: 'POST',
