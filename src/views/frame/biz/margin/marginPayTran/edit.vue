...
export default {
  ...
  data() {
    return {
      edit: {
        ...
        api: {
          view: '/api/margin/marginPayTran/get',
          save: '/api/margin/marginPayTran/save',
          update: '/api/margin/marginPayTran/update'
        },
        apiData: {
          view(param) {
        ...
        topButtons: [
          ...
          },
          {
            ...
            isShow: ['add'],
            event: 'set',
            component: () => import('./chooseMarginPayTran.vue'),
        ...
        tabs: [
          {
            ...
            name: 'marginPayTranDeDtoList',
            label: 'margin.marginPayTran.group.transferDetailInfoTab',
            component: () => import('./marginPayTranDetailInfoTab.vue'),
            required: true
          }
        ]
      }
  ...
  methods: {
    ...
    clearTransferDetailInfo() {
      this.$refs.qmEdit.$refs.qmRouteEdit.$refs.marginPayTranDeDtoList[0].$refs.tab.tableData = []
    }
  }
}
</script>
