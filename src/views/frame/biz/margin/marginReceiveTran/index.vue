...
export default {
  ...
  data() {
    return {
      ...
      mainData: {
        api: {
          cancelAudit: '/api/margin/marginReceiveTran/cancelAudit',
          search: '/api/margin/marginReceiveTran/list',
          export: '/api/margin/marginReceiveTran/export',
          doDelete: '/api/margin/marginReceiveTran/remove'
        },
        apiData: {
          search(param) {
            return param
        ...
        topBar: [
          {
            ...
            routeInfo() {
              return {
                name: 'marginReceiveTranAdd',
                params: {
                  type: 'add',
                  back: 'marginReceiveTran'
                }
              }
            }
          },
          {
            ...
            validateApi(row) {
              return {
                url: '/api/margin/marginReceiveTran/validatedApi',
                data: row.transferNo
              }
            }
          },
