...
export default {
  data() {
    return {
      tab: {
        ...
        api: {
          search: '/api/margin/marginReceiveTranDe/listByTransferNo'
        },
        apiData: {
          search(param) {
        ...
        table: {
          ...
          cols: [
            ...
            // 批次类型
            {
              label: 'margin.marginPayTran.list.lotType',
              prop: 'lotType',
              width: 80,
              align: 'center',
              format: {
            ...
            // 资金用途
            {
              label: 'margin.marginPayTran.list.fundUseType',
              prop: 'fundUseType',
              width: 100,
              align: 'center',
              element: 'base-select',
  ...
  methods: {
    ...
    initChooseAdd() {
      ...
      const editFrom = toolUtil.getDataEditFromTab(this)
      if (editFrom.billType === 'CON_SL_INFO') {
        param.lotNo = {
          disabled: true,
          value: this.editForm.billNo
        }
      }
      return param
    },
    ...
    handleCloseDialog(params) {
      ...
      params.forEach((row, index) => {
        ...
        this.$refs.tab.tableData[_index]['customerNo'] = this.editForm.customerNo
        this.$refs.tab.tableData[_index]['customerName'] = this.editForm.customerName
