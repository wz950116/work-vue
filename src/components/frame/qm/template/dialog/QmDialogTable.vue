  ...
  <div v-el-drag-dialog class='dialog-wrapper'>
    <div ref='formTableDialog' class='dialog-container' type='formTableDialog'>
      ...
      <main>
        ...
        <el-table v-if='dialog.mainData.linkTable' stripe border class='table-content' ref="linkTable" highlight-current-row v-loading="loading" element-loading-spinner="el-icon-loading" style="border:1px solid;margin-top:3px;" :element-loading-text="$t('route.load')" :data="linkTableData" :height='150' @selection-change="handleSelectionChangeLv2" @current-change="handleSelectRowLv2" @row-click='handleClickLv2' @row-dblclick="handleDblClick">
          <el-table-column align='center' type="index" fixed="left" width="50" :label='$t("table.id")'></el-table-column>
          <el-table-column type="selection" width="55" align="center" :fixed="dialog.mainData.table.selectionFixed" v-if="dialog.mainData.table.showCheckbox"></el-table-column>
